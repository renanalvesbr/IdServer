...
using Senff.IdServer.Admin.Api.Configuration;
using Senff.IdServer.Admin.Api.Configuration.Authorization;
using Senff.IdServer.Admin.Api.ExceptionHandling;
using Senff.IdServer.Admin.Api.Helpers;
using Senff.IdServer.Admin.Api.Mappers;
using Senff.IdServer.Admin.Api.Resources;
using Senff.IdServer.Admin.EntityFramework.Shared.Entities.Identity;
using Senff.IdServer.Data.Shared.DbContexts;
using Senff.IdServer.Shared.Dtos;
using Senff.IdServer.Shared.Dtos.Identity;
...
namespace Senff.IdServer.Admin.Api
{
