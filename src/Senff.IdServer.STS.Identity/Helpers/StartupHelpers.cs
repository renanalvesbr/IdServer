...
using Senff.IdServer.STS.Identity.Configuration;
using Senff.IdServer.STS.Identity.Configuration.ApplicationParts;
using Senff.IdServer.STS.Identity.Configuration.Constants;
using Senff.IdServer.STS.Identity.Configuration.Interfaces;
using Senff.IdServer.STS.Identity.Helpers.Localization;
using System.Linq;
...
namespace Senff.IdServer.STS.Identity.Helpers
{
